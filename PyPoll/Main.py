...
election_data = os.path.join("..", "Resources","/Users/suraksharegmi/desktop/Module3/python-challenge/PyPoll/Resources/election_data.csv")
...
output = open("/Users/suraksharegmi/desktop/Module3/python-challenge/PyPoll/analysis/output.txt", "w")
